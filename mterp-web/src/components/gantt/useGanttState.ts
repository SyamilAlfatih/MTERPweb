...
export const DEFAULT_COLUMNS: ColumnDef[] = [
  ...
  { id: 'itemType', label: 'Tipe', width: 75, minWidth: 60, visible: true, align: 'center' },
  { id: 'quantity', label: 'Vol/Qty', width: 75, minWidth: 55, visible: false, align: 'right' },
  { id: 'unit', label: 'Satuan', width: 65, minWidth: 50, visible: false, align: 'center' },
  { id: 'unitRate', label: 'Harga Satuan', width: 105, minWidth: 80, visible: false, align: 'right' },
